    ...
    <div>
      <div className="mt-10 space-y-6">
        ...
        <p className="text-center font-bold ">
          If you know about the power of social proof, you know how important it
          is to have reviews on your website.
          <br /> But those reviews don’t need to stay static wherever your
          customers felt inspired to post
        </p>
      </div>
        ...
        <div className="container flex flex-col w-full max-w-lg p-6 mx-auto divide-y rounded-md dark:divide-gray-300 dark:bg-gray-50 dark:text-gray-800">
          <div className="flex justify-between p-4">
            <div className="flex space-x-4">
              <div>
                <img
                  src="https://i.ibb.co/2KSk9mn/pretty-student-girl-studying-remotely-260nw-1942302184.webp"
                  alt=""
        ...
        <div className="container flex flex-col w-full max-w-lg p-6 mx-auto divide-y rounded-md dark:divide-gray-300 dark:bg-gray-50 dark:text-gray-800">
          <div className="flex justify-between p-4">
            <div className="flex space-x-4">
              <div>
                <img
                  src="https://i.ibb.co/TMx7BJc/young-happy-latin-woman-using-260nw-2277463121.webp"
                  alt=""
                  className="object-cover w-12 h-12 rounded-full dark:bg-gray-500"
                />
              </div>
        ...
        <div className="container flex flex-col w-full max-w-lg p-6 mx-auto divide-y rounded-md dark:divide-gray-300 dark:bg-gray-50 dark:text-gray-800">
          <div className="flex justify-between p-4">
            <div className="flex space-x-4">
              <div>
                <img
                  src="https://i.ibb.co/LpcMygg/lovepik-girls-on-the-internet-png-image-400944926-wh860.png"
                  alt=""
                  className="object-cover w-12 h-12 rounded-full dark:bg-gray-500"
                />
              </div>
